...
export const AppBar: React.FC = () => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="hidden md:block newsletter container-fluid text-center  p-2 " style={{backgroundColor:"#141414"}}>
        Subscribe to our Newsletter For New & latest Blogs and Resources
        <svg className='mx-2' style={{display:'inline'}} width="14" height="14" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M4.75 0.75L16 0.75C16.1989 0.75 16.3897 0.829018 16.5303 0.96967C16.671 1.11032 16.75 1.30109 16.75 1.5V12.75C16.75 13.1642 16.4142 13.5 16 13.5C15.5858 13.5 15.25 13.1642 15.25 12.75V3.31066L1.53033 17.0303C1.23744 17.3232 0.762563 17.3232 0.46967 17.0303C0.176777 16.7374 0.176777 16.2626 0.46967 15.9697L14.1893 2.25L4.75 2.25C4.33579 2.25 4 1.91421 4 1.5C4 1.08579 4.33579 0.75 4.75 0.75Z" fill="#FFD11A" />
        </svg>

      </div>
      <div className="navbar flex h-15 flex-row md:mb-2 shadow-lg text-secondary-content border-b border-zinc-600 bg-gradient-to-tr from-fuchsia-600 to-purple-600">
        ...
        <div className="navbar-end">
          ...
          <NavElement
            ...
            navigationStarts={() => setIsNavOpen(false)}
          /> */}
            <WalletMultiButtonDynamic className="btn-primary btn-sm rounded-btn text-lg mr-6 " />
          </div>
          {/* <label
              htmlFor="my-drawer"
